 <?php 
    use App\Admin ;
    $admins = Admin::select('id','name')->get(); // Test Get All Admins 
?>
<!DOCTYPE html>
                ...
                <div class="row">
                    ...
                    <div id="main_list" class="hidden-sm hidden-xs mini">
                        <div class="chat-window-title" onClick="chat_list_toggle()" id="main_title">
                            <div class="text" dir="ltr"> Admins Online ( {{@$admins->count()}} ) </div>
                        </div>
                        <div class="chat-window-content">
                            <div class="chat-window-inner-content user-list">
                                <div id="users">
                                    @foreach(@$admins as $admin)
                                         <div class="user-list-item" onclick="open_window({{$admin->id}})" data-val-id="{{$admin->id}}">
                                        <!-- <i class="fa fa-circle online-status"></i> -->
                                            <div class="content">{{ $admin->name }}</div>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
